...
@section('title', 'Detalle de Compra | Sistema de Administración')
    ...
    <aside class="barra-lateral">
        ...
        <div class="seccion-formulario">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <p><strong>Factura:</strong> {{ $purchase->invoice_number ?? 'N/A' }}</p>
                ...
                @if($purchase->notes)
                    ...
                    <p style="font-size: 0.9em;">{{ $purchase->notes }}</p>
                @endif
            </div>
            
            <a href="{{ route('purchases.index') }}" class="btn-listo" style="display: inline-block; text-align: center;">
                Volver a Compras
            </a>
        </div>
    </aside>
